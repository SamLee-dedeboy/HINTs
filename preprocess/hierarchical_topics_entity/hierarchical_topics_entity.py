...
if __name__ == "__main__":
    ...
    hierarchy = json.load(open('ravasz_hierarchies_entity.json'))
    partitions = json.load(open('ravasz_partitions_entity.json'))
    # article
    ...
    entities_dict = json.load(open('entities.json'))
    ...
    topic_dict = json.load(open('hierarchical_topics_entities.json'))
    ...
    breakpoint_filepath = 'hierarchical_topics_entities.json'
