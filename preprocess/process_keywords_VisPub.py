...
def explain_keyword_prompts(keyword):
    ...
    return messages
    try:
        explanation = request_gpt(messages)
    except:
        print("retrying...")
        explanation = request_gpt(messages)
    return explanation
...
def main():
    ...
    print("saving keyword explanations to: test/data/result/VisPub/keywords/keywords_explanations_embeddings.json")
    save_json(keyword_explanations, "test/data/result/VisPub/keywords/keywords_explanations_embeddings.json")
    ...
    print("saving disambiguated keywords to: test/data/result/VisPub/keywords/disambiguated_keywords.json")
    save_json(disambiguated_keywords, 'test/data/result/VisPub/keywords/disambiguated_keywords.json')

    print("saving articles with disambiguated keywords...")
    keyword_disambiguation = json.load(open('data/result/VisPub/keywords/disambiguated_keywords.json'))
    for article in articles:
    ...
    save_json(articles, 'test/data/result/VisPub/articles_w_keywords.json')


    # also extract spans using gpt
    if args['spans']:
        print("extracting spans...")
        articles_w_keywords = json.load(open("test/data/result/VisPub/articles_w_keywords.json"))
        article_spans = {}
        ...
        print("saving spans to: test/data/result/VisPub/article_participant_spans.json")
        save_json(article_spans, 'test/data/result/VisPub/article_participant_spans.json')
    end_time = time.time()
