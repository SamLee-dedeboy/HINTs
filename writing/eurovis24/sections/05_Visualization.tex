\begin{figure}%
    ...
    % \qquad
    \subfloat[\centering Four concatenated Gilbert curves. Color transitions from dark blue to dark red indicate the traverse direction.]{{\includegraphics[width=0.43\columnwidth]{concatenated_gilbert} }}%
    \qquad
    ...
    \qquad
    \subfloat[\centering An order-4 Gosper curve]{{\includegraphics[width=0.43\columnwidth]{gosper} }}%
    \qquad
...
%     \qquad
%     \subfloat[\centering Labels of the keyword cluster. The left part shows the categories of the keywords as the cluster label. When documents are selected, the right part appears and shows the connected keywords.\label{fig: keyword-cluster-label}]{{\includegraphics[width=5cm]{keyword_cluster_label} }}%
%     \caption{(a) Labels (topics) of the document clusters (b) An example of expanded cluster labels (c) An example of keyword labels (categories) and highlighted keywords}%
%     \label{fig: labels}%
% \end{figure}
