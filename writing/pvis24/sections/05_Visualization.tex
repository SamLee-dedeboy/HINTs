...
\begin{figure}%
    ...
    \qquad
    \subfloat[\centering Four concatenated Gilbert curves\label{fig: gilbert_concat}]{{\includegraphics[width=0.45\columnwidth]{concatenated_gilbert} }}%
    \qquad
    \subfloat[\centering An order-4 Gosper curve\label{fig: gosper}]{{\includegraphics[width=0.45\columnwidth]{gosper} }}%
    \caption{
...
\begin{figure}%
    \centering
    \subfloat[\centering ]{{\includegraphics[width=0.45\columnwidth]{example_gilbert_border} }}%
    \qquad
    \subfloat[\centering ]{{\includegraphics[width=0.45\columnwidth]{example_gosper_border} }}%
