...
In this paper, we propose a visual analytics system that allows analysts to explore and reorganize a corpus to suit their needs.
...
The clustered result is visualized for analysts to explore and reorganize interactively. 
